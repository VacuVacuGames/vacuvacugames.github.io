...
var DefPointerLock = {
  ...
  onPointerLockChange: function onPointerLockChange() {
    var locked = (document.pointerLockElement || document.mozPointerLockElement || document.webkitPointerLockElement || document.msPointerLockElement) == Module.canvas;
    getWasmTableEntry(DefPointerLock._onPointerLockChange)(locked);
  },
  onPointerLockError: function onPointerLockError(e) {
    console.log("onPointerLockError", e);
  },
  _onCanvasClick: null,
  onCanvasClick: function onCanvasClick(e) {
    getWasmTableEntry(DefPointerLock._onCanvasClick)();
  }
};
function _DefPointerLock_ExitPointerLock() {
...
function _DefPointerLock_Final() {
...
function _DefPointerLock_Init(onChange, onClick) {
  var self = DefPointerLock;
...
function _DefPointerLock_RequestPointerLock() {
...
var wasmImports = {
  Ph: _DefPointerLock_ExitPointerLock,
  Oh: _DefPointerLock_Final,
  Nh: _DefPointerLock_Init,
  Mh: _DefPointerLock_RequestPointerLock,
  b: ___assert_fail,
